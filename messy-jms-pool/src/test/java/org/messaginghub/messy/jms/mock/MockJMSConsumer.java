...
public class MockJMSConsumer implements JMSConsumer, AutoCloseable {

    private final MockJMSSession session;
    private final MockJMSMessageConsumer consumer;

    public MockJMSConsumer(MockJMSSession session, MockJMSMessageConsumer consumer) {
